...
export const CAT_QUESTION_STRINGS = [
  ...
  "보호자 근처에 자주 머무른다./S",
  "보호자의 귀가 시간이 달라지면 반응이 바뀐다./T",
  "하루 중 뛰거나 사냥 놀이를 자주 한다./E",
  "스트레스 상황 후 식욕이 떨어지거나 식사를 거부하는 반응이 나타난다./R",
  "쓰다듬거나 스킨십을 먼저 요청한다./S",
  "움직이는 물체를 발견하면 즉시 추격하거나 덮치려는 행동을 보인다./E",
  "특정 장소(캣타워, 창가 등)를 고집한다./T",
  "낯선 사람에게 비교적 경계가 적다./S",
  "새로운 장난감을 주면 경계한다./R",  //10
  "밤 시간에 활동량이 많다./E",
  "가구 배치가 바뀌면 익숙한 자리를 찾아 재탐색하는 행동을 보인다./T",
